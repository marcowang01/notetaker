    ...
    <div className="flex items-center justify-end px-2">
      ...
      <div className="flex items-center space-x-6 lg:space-x-8">
        <div className="flex items-center space-x-2">
          ...
          >
            <SelectTrigger className="h-8 w-[70px] border-gray-350 shadow-none">
        ...
        <div className="flex items-center space-x-2">
          <Button
            variant="outline"
            className="h-8 w-8 p-0 lg:flex bg-gray-350 border-none"
          ...
          <Button
            variant="outline"
            className="h-8 w-8 p-0 bg-gray-350 border-none"
